...
while True:
    ...
    # Define the central rectangle of size 40x40
    ...
    # Display the dominant color bar using matplotlib
    plt.axis("off")
    plt.imshow(bar)
    plt.pause(0.05)  # display for a short period so the loop continues smoothly
    plt.clf()

    # Display the original frame and the cropped region using cv2
